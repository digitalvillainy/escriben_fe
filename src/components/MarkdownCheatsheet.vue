<template>
  ...
  <h1 class="text-5xl" data-toc-skip>Markdown Cheat Sheet</h1>
      ...
      <div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td><a href="/extended-syntax/#emoji">Emoji</a><br />(see also <a
                  href="/extended-syntax/#copying-and-pasting-emoji">Copying and Pasting Emoji</a>)</td>
              <td><code>
