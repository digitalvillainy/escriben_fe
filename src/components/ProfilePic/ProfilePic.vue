...
let base64Image = ref<string | ArrayBuffer | null | undefined>(null);

//Computed property for profile picture
const profilePic = (): string | null | undefined => {
...
const updateProfilePic = (event: Event | null) => {
...
<template>
    <div class="flex flex-col space-y-8">
        ...
        <img
            v-if="base64Image === 'null'"
            :src="base64Image"
            class="size-56 rounded-full object-cover"
        />
        <input
            type="file"
            class="hidden"
