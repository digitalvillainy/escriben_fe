...
<template>
	<div>
		<svg width="512" height="512" viewBox="0 0 512 512" class="w-8 h-8 fill-white cursor-pointer hover:fill-cyan-400"
			xmlns="http://www.w3.org/2000/svg" @click="showModal = true">
			<g clip-path="url(#clip0_2297_4)">
				<path
