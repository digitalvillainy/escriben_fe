...
<template>
    <Layout>
        <template #content>
            <form
                class="flex flex-col justify-center place-items-center flex-grow w-full"
                @submit.prevent="submitForm"
            >
                <StepCard
                    class="w-11/12 mx-auto lg:w-[49rem] lg:h-[25rem] drop-shadow-2xl border-black border-2 flex flex-col"
                >
